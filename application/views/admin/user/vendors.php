  ...
  <section class="content ">
      ...
      <?php if (isset($page_title) && $page_title != "Edit"): ?>
        <div class="list_area container">
          ...
          <?php else: ?>
            <h3 class="box-title"><?php echo trans('vendors') ?> <a href="#" class="pull-right btn btn-info btn-sm rounded add_btn"><i class="fa fa-plus"></i> <?php echo trans('add-new-vendor') ?></a></h3>
          <?php endif; ?>

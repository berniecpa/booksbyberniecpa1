            ...
            <div class="print_area">
              ...
              <div class="profit-and-loss-report mt-50">
                  ...
                  <div class="profit-and-loss-single">
                    ...
                    <?php else: ?>
                      <h1 class="fs-40 text-success"><?php echo $this->business->currency_symbol.' '.number_format($profitloss, 2); ?></h1>
                    <?php endif; ?>
                  </div>
              </div>
              ...
              <div class="profit-and-loss-report pt-10">
                  ...
                  <div class="mb-10">
                    ...
                    <?php else: ?>
                      <p class="fs-20 p-0 m-0 text-success"><?php echo $this->business->currency_code.' '.number_format($profitloss, 2); ?></p>
                    <?php endif; ?>
                  </div>
              </div>

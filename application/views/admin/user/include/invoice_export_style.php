            ...
            <table class="table">
                <thead class="pre_head2">
                    <tr class="pre_head_tr2 inv-pl30">
                        <th class="border-0" style="color: #333; background: #fafafa; font-weight: bold; "><?php echo trans('items') ?></th>
                        <th class="border-0" style="color: #333; background: #fafafa; font-weight: bold; "><?php echo trans('price') ?></th>
                        <th class="border-0" style="color: #333; background: #fafafa; font-weight: bold; "><?php echo trans('quantity') ?></th>
                        <th class="border-0" style="color: #333; background: #fafafa; font-weight: bold; "><?php echo trans('amount') ?></th>
                    </tr>
                </thead>
                <tbody>

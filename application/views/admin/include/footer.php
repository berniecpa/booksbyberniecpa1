  ...
  Highcharts.chart('incomeChart', {
      ...
      plotOptions: {
          series: {
              ...
              dataLabels: {
                  enabled: true,
                  format: '<?php echo html_escape($currency) ?> {point.y:.2f}'
              }
          }
      },
      ...
      tooltip: {
          ...
          pointFormat: '<span style="color:{point.color}">{point.name}</span> <b><?php echo html_escape($currency) ?> {point.y:.2f}</b><br/>'
      },
